...
//        projectRepository.save(project);
    ...
    public Employee assignDepartment(int empId, int deptId){
        Employee emp = employeeRepository.findById(empId).orElseThrow(() -> new RuntimeException("Employee ID is incorrect"));
        Department dept = departmentRepository.findById(deptId).orElseThrow(()-> new RuntimeException("Department ID is incorrect"));
